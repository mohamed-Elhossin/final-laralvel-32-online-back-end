            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        {{-- User + admin --}}
                        <!-- Vertical Form -->
                        <form method="post" action="{{ route('admin.update', $admin->id) }}" class="row g-3">
                            @csrf
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                ...
                                <input type="email" name="email" value="{{ $admin->user->email }}" class="form-control" id="inputEmail4">
                            </div>

                            <div class="col-12">
                                <label for="inputAddress" class="form-label">position</label>
                                <input type="text" class="form-control"  value="{{ $admin->position }}" name="position" id="inputAddress"
